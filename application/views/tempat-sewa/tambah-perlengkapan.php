     ...
     <div class="main-content">
         <section class="section">
             <div class="section-header">
                 <h1>Tambah Data Perlengkapan</h1>
             </div>
             <form action="<?= base_url() ?>tempat-sewa/perlengkapan/aksi_tambah_perlengkapan" enctype="multipart/form-data" method="post">
                 <?php
                    error_reporting(0);
                    if ($kode->id_perlengkapan != null) {
                        $id_perlengkapan = $kode->id_perlengkapan;
                    } else {
                        $id_perlengkapan = "plk-0000";
                    }
