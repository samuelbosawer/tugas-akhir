     ...
     <div class="main-content">
         <section class="section">
             ...
             <form action="<?= base_url() ?>tempat-sewa/paket/aksi_ubah_paket" enctype="multipart/form-data" method="post">
                         ...
                         <div class="card-body">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                     ...
                                     <input type="file" name="foto" class="form-control mt-2" id="" placeholder="" value="<?= set_value('foto') ?>">
                                     <?= form_error(
                                            'foto',
                                            '<div class="text-small text-danger">',
                                            '</div>'
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                     <textarea class="form-control" name="deskripsi" id="" style="height: 200px;"> <?= $d->deskripsi ?> </textarea>
                                     <?= form_error(
                                            'deskripsi',
                                            '<div class="text-small text-danger">',
                                            '</div>'
